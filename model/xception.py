...
class Xception(nn.Module):
    ...
    """
    def __init__(self, downsample_factor,image_C=3):
        """ Constructor
        Args:
        ...
        self.conv1 = nn.Conv2d(image_C, 32, 3, 2, 1, bias=False)
...
def xception(pretrained=True, downsample_factor=16,image_C=3):
    model = Xception(downsample_factor=downsample_factor,image_C=image_C)
    if pretrained:
